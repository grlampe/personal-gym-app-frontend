...
export function CompanyEditPage() {
  ...
  const { id } = useParams<CompanyEditParams>();
  ...
  useEffect(() =>{
    setPageTitle(id ? 'Editando Empresa' : 'Cadastrando Empresa');
    setUserData();
  },[]);
  ...
  const validateForm = (values: CompanyForm) => {
    const errors: ErrorCompanyForm = {};
    if (!values.fullName) {
